    ...
    <>
      ...
      <main className="pt-16">
        ...
        <section style={{ background: '#111111', padding: '72px 0 64px', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', top: '-80px', right: '-80px', width: '500px', height: '500px', background: 'radial-gradient(circle, rgba(19, 50, 141,0.12) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
          <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
            ...
            <h1 style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 800, letterSpacing: '-1.5px', lineHeight: 1.1, color: '#FFFFFF', marginBottom: '16px' }}>
              Erzählen Sie uns<br />
              <span style={{ color: '#13328D' }}>von Ihrer Idee</span>
            </h1>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', justifyContent: 'center' }}>
              {['24h Antwortzeit', 'Kostenlos & unverbindlich', 'Schweizer Qualität'].map((badge) => (
                <span
                  key={badge}
                  style={{ background: 'rgba(19, 50, 141,0.12)', border: '1px solid rgba(19, 50, 141,0.25)', color: '#4F6FBF', borderRadius: '100px', padding: '5px 14px', fontSize: '12px', fontWeight: 500 }}
                >
                  {badge}
                </span>
              ))}
