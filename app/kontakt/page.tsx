        ...
        <section style={{ background: '#111111', padding: '80px 0 72px' }}>
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <h1 style={{ fontSize: 'clamp(36px, 5vw, 56px)', fontWeight: 800, letterSpacing: '-2px', lineHeight: 1.05, color: '#FFFFFF', marginBottom: '16px' }}>
              So erreichen<br />
              <span style={{ color: '#13328D' }}>Sie uns</span>
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" style={{ marginBottom: '64px' }}>
              ...
              <div style={{ background: '#F8F9FA', borderRadius: '20px', padding: '36px', border: '1px solid #EFEFEF' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: '#E0E7F5', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                  <MapPin size={22} style={{ color: '#13328D' }} />
                </div>
              ...
              <div style={{ background: '#F8F9FA', borderRadius: '20px', padding: '36px', border: '1px solid #EFEFEF' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: '#E0E7F5', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                  <Mail size={22} style={{ color: '#13328D' }} />
                </div>
                <h2 style={{ fontSize: '16px', fontWeight: 700, color: '#111111', marginBottom: '10px' }}>E-Mail</h2>
                <a
                  href={`mailto:${FIRMA.email}`}
                  style={{ fontSize: '15px', color: '#13328D', textDecoration: 'none', fontWeight: 600 }}
                >
                  {FIRMA.email}
                </a>
              ...
              <div style={{ background: '#F8F9FA', borderRadius: '20px', padding: '36px', border: '1px solid #EFEFEF' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: '#E0E7F5', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                  <Clock size={22} style={{ color: '#13328D' }} />
                </div>
              ...
              <div style={{ background: '#F8F9FA', borderRadius: '20px', padding: '36px', border: '1px solid #EFEFEF' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: '#E0E7F5', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#13328D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="#13328D" stroke="none"/></svg>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6B7280', lineHeight: 1.7, marginBottom: '24px' }}>
                  ...
                  <Link href="/anfrage" style={{ color: '#13328D', textDecoration: 'none', fontWeight: 600 }}>
                    Anfrageformular
                  </Link>.
                </p>
                <KontaktForm />
              ...
              {/* Right: CTA banner */}
              <div style={{ background: 'linear-gradient(135deg, #13328D 0%, #0E2570 100%)', borderRadius: '24px', padding: '48px 40px', position: 'relative', overflow: 'hidden' }}>
                ...
                <Link
                  href="/anfrage"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'white', color: '#13328D', padding: '12px 24px', borderRadius: '10px', fontSize: '14px', fontWeight: 700, textDecoration: 'none' }}
                >
                  Jetzt anfragen
                  <ArrowRight size={15} />
                </Link>
