  ...
  return (
    <div className="float-animate" style={{ width: '100%', maxWidth: '480px' }}>
      <svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', filter: 'drop-shadow(0 24px 48px rgba(0,0,0,0.12))' }}>
        ...
        <rect x="12" y="68" width="48" height="48" rx="10" fill="#13328D" fillOpacity="0.1"/>
        <rect x="20" y="80" width="32" height="4" rx="2" fill="#13328D"/>
        <rect x="20" y="90" width="24" height="3" rx="1.5" fill="#4F6FBF"/>
        ...
        <rect x="104" y="78" width="40" height="6" rx="3" fill="#13328D"/>
        ...
        <rect x="108" y="226" width="20" height="30" rx="4" fill="#E0E7F5"/>
        <rect x="136" y="210" width="20" height="46" rx="4" fill="#A8B5DD"/>
        <rect x="164" y="196" width="20" height="60" rx="4" fill="#4F6FBF"/>
        <rect x="192" y="200" width="20" height="56" rx="4" fill="#13328D"/>
        <rect x="220" y="186" width="20" height="70" rx="4" fill="#0E2570"/>
        <rect x="248" y="192" width="20" height="64" rx="4" fill="#0E2570"/>
        ...
        <circle cx="326" cy="196" r="8" fill="#E0E7F5"/>
        ...
        <rect x="104" y="304" width="120" height="16" rx="4" fill="#13328D"/>
...
export default function Hero() {
  return (
    <section style={{ minHeight: '100vh', background: '#FFFFFF', position: 'relative', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: '-200px', right: '-200px', width: '600px', height: '600px', background: 'radial-gradient(circle, rgba(19, 50, 141,0.05) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: 0, left: '-100px', width: '300px', height: '300px', background: 'radial-gradient(circle, rgba(19, 50, 141,0.04) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="fade-up" style={{ marginBottom: '28px' }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(19, 50, 141,0.04)', border: '1px solid rgba(19, 50, 141,0.2)', color: '#13328D', borderRadius: '100px', padding: '6px 16px', fontSize: '13px', fontWeight: 500 }}>
            ...
            <h1 className="fade-up-1" style={{ fontSize: 'clamp(32px, 5.5vw, 72px)', fontWeight: 800, letterSpacing: '-2px', lineHeight: 1.05, color: '#111111', marginBottom: '24px' }}>
              ...
              <span style={{ color: '#13328D' }}>Produkte die wirken.</span>
            </h1>
            ...
            <div className="fade-up-3 hero-btns" style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', marginBottom: '48px' }}>
              <Link
                ...
                style={{ background: '#13328D', color: 'white', padding: '14px 28px', borderRadius: '10px', fontSize: '15px', fontWeight: 600, transition: 'all 0.25s ease', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minHeight: '44px' }}
                onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(19, 50, 141,0.4)'; e.currentTarget.style.background = '#0E2570' }}
                onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.background = '#13328D' }}
              >
                Projekt starten
              </Link>
              <Link
                ...
                onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#13328D'; e.currentTarget.style.color = '#13328D' }}
                ...
                {[
                  ...
                  <div key={stat.label}>
                    <div style={{ fontSize: '32px', fontWeight: 800, color: '#111111', lineHeight: 1, marginBottom: '4px' }}>
                      {stat.value}<span style={{ color: '#13328D' }}>{stat.suffix}</span>
                    </div>
