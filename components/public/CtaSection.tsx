...
export default function CtaSection() {
  return (
    <section style={{ background: 'linear-gradient(135deg, #13328D 0%, #0E2570 100%)', padding: '120px 0', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="animate-on-scroll" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '12px' }}>
          <Link
            href="/anfrage"
            style={{ background: '#FFFFFF', color: '#13328D', padding: '14px 32px', borderRadius: '10px', fontSize: '15px', fontWeight: 700, transition: 'all 0.25s ease', display: 'inline-flex', alignItems: 'center' }}
